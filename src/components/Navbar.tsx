...
const Navbar = () => {
  return (
    <div className='flex justify-between  items-center p-4 px-20  top-0  z-10 w-full  fixed text-white backdrop-blur-2xl'> 
        <h1 className='font-bold text-2xl'>Aarcee <span className='text-green-800'>Casting</span></h1>
