...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-black via-[#8E1616] to-black backdrop-blur-lg border-b border-[#E8C999]/20 shadow-lg">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link 
              href="/" 
              className="text-[#F8EEDF] hover:text-[#E8C999] font-medium transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#E8C999] hover:after:w-full after:transition-all"
            >
              Home
            </Link>
            <Link 
          ...
          <div className="md:hidden">
            <button 
              ...
              className="p-2 text-white hover:text-[#E8C999] transition-colors"
            >
      ...
      {/* Mobile menu panel */}
      {open && (
        <div className="md:hidden bg-gradient-to-br from-black to-[#8E1616] border-t border-[#E8C999]/20 shadow-xl">
