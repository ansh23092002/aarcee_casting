...
const Navbar: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 ${pathname === '/products'|| pathname === '/about' ? 'bg-black' : 'bg-transparent backdrop-blur-md'} border-b border-white/10 shadow-lg`}>
