    ...
    <div className="relative bg-black min-h-screen">
      ...
      <div className="absolute inset-0 flex items-center justify-start px-4 sm:px-8 md:px-16">
        <div className="text-left text-white max-w-2xl">
          <h1 className="font-bold text-2xl sm:text-4xl md:text-6xl lg:text-7xl mb-4 sm:mb-6 leading-tight">
            Precision Steel <br />
            <span className="text-[#E8C999]">Casting Solutions</span>
          </h1>
          <p className="text-gray-300 text-sm sm:text-lg md:text-xl mb-6 sm:mb-8">
